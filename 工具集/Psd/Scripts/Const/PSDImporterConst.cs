...
namespace Psd
{
    ...
    {
        public const string RESOURECEDIR = "Assets/UIRes/";//UI资源路径
        public const string BASE_FOLDER = "UI/";
        public const string PNG_SUFFIX = ".png";
        //公共系统名
        public const string CommonSys = "Common";
        ...
        //字体路径，按需修改
        public const string FONT_FOLDER = "Assets/Font/";
        ...
        public const string PSDUI_PATH = "Assets/Psd/Template/";
